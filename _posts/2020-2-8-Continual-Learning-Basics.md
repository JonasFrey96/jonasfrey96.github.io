...
Another example might be if you want to have a model that learns about political landscape across nations.
...
In contrast to normal Rehearsal approach the samples of an old task can be generated by sampling from the generator network. 
